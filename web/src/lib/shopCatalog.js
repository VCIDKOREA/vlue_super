...
export const HUB_BUSINESSES = [
  { id: "biz-food-1", name: "소울 커피 로스터스", img: "https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=900&q=80", roomId: "subscribe:soul-cafe", intro: "스페셜티 원두와 브런치" },
  { id: "biz-food-2", name: "청담 만리장성", img: "https://images.unsplash.com/photo-1583032015879-e5022cb87c3b?w=900&q=80", roomId: "friends:friend-kim", intro: "직화 짜장과 탕수육" },
  { id: "biz-beauty-1", name: "청담 헤어 라운지", img: "https://images.unsplash.com/photo-1560066984-138dadb4c035?w=900&q=80", roomId: "subscribe:blue-repair", intro: "프리미엄 헤어 디자인" },
  { id: "biz-edu-1", name: "강남 영수 에이스", img: "https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=900&q=80", roomId: "friends:brother", intro: "초중고 영수 코칭" },
  { id: "biz-repair-1", name: "블루 모터스", img: "https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=900&q=80", roomId: "subscribe:blue-repair", intro: "자동차 경정비" },
  { id: "biz-recruit-1", name: "커리어 센터", img: "https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=900&q=80", roomId: "subscribe:career-center", intro: "채용·면접 매칭" },
  { id: "biz-med-1", name: "강남 메디컬 내과", img: "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=900&q=80", roomId: "work:park", intro: "건강검진·내과" }
];
