...
/** @typedef {{ id: string, label: string, query: string }} SoundCloudGenreDef */

/** @type {SoundCloudGenreDef[]} */
export const SOUNDCLOUD_GENRE_CURATIONS = [
  {
    id: "kpop",
    label: "K-POP",
...
export function getSoundCloudGenreById(id) {
