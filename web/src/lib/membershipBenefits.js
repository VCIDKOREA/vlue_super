...
export const MEMBERSHIP_BENEFIT_ROWS = [
  ...
  {
    label: "가족플랜 혜택",
    free: "유료 보호자 등록 시 쇼케이스 5페이지·BGM 풀 등 (DCC 제외)",
    paid: "쇼케이스·BGM 상속 (DCC는 본인 유료)",
    b2b: "—"
  },
  {
    label: "추가번호 쇼케이스 송출",
...
export const MEMBERSHIP_PLAN_DETAILS = {
  free: {
    ...
    bullets: [
      ...
      "비즈니스 링크·디지털인증명함(DCC)은 본인 정식 유료 구독으로만 발급·이용할 수 있습니다.",
      "유료 보호자 가족플랜 등록 시 쇼케이스 5페이지·BGM 풀 등 유료 쇼케이스 기능을 이용할 수 있습니다. DCC는 가족플랜에 포함되지 않으며 별도 유료 결제가 필요합니다.",
