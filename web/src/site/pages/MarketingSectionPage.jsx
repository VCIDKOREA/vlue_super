...
const SECTION_COPY = {
  ...
  news: { title: "기업뉴스", body: "VLUÉ의 공지·보도자료·업데이트 소식이 이곳에 표시됩니다." },
  ...
  pricing: {
    title: "인증신청(요금제)",
    body: "V1 요금제: 무료·유료(월 9,900원·정가 28,300원 65% 특별 할인)·B2B 풀 패키지(직원 회선 이벤트 5,200원)·SOHO 영업 송출(+4,200원). 쇼케이스·디지털 인증명함·가족보호 중심. 가입·결제는 VLUÉ 앱에서 진행합니다.",
  },
  jobs: { title: "구인구직", body: "VLUÉ 파트너·지역협력 채용 공고가 연동됩니다." },
  shopping: {
    title: "블루쇼핑",
