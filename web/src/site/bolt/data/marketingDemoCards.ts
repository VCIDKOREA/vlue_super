...
export const MARKETING_DEMO_CARDS = {
  police112: {
    ...
    logoUrl: '',
    companyIntro:
      '국가공공 긴급신고 112입니다. VLUÉ 인증 디지털명함으로 수신 화면 풀 쇼케이스에 기관이 확인됩니다.',
    roleLine: '긴급신고 / 112',
  },
  fss1332: {
    organization: '금융감독원',
    name: '1332',
    title: '금융민원',
    department: '대표번호 · VLUÉ 인증',
    phone: '1332',
    fax: '02-3145-8000',
    email: '1332@fss.or.kr',
    website: 'fss.or.kr',
    logoUrl: '',
    companyIntro: '금융감독원 대표번호 1332입니다. VLUÉ 인증 디지털명함으로 풀 쇼케이스에 기관이 확인됩니다.',
    roleLine: '금융민원 / 1332',
  },
