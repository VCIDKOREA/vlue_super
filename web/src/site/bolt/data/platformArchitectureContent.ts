  ...
  exclusive: [
    {
      ...
      summary: '웹 전용 UI',
      detail:
        '기관명·전화번호·사업자번호를 공공데이터와 VLUÉ 인증 DB로 동시 검증. 마케팅 홈·서비스소개 검색 허브에서 제공합니다.',
    },
    {
      id: 'pricing',
      title: 'V1 멤버십·요금제',
      summary: '웹 안내',
      detail: '무료·유료·B2B 요금제를 비교합니다. 가입·결제는 VLUÉ 앱에서 진행합니다.',
    },
  ],
...
export const APP_PLATFORM = {
  ...
  exclusive: [
    ...
    },
    {
      ...
      title: '하드웨어 연동',
      summary: '네이티브 연동',
      detail: 'Android 통화 레터링 오버레이, 가족보호 브릿지, WebView 기반 VLUÉ 앱 셸.',
    },
  ],
