...
const RESPONSES: [RegExp, string][] = [
  ...
  [/유심|심카드|번호\s*변경|기기\s*변경|휴대폰\s*교체|폰\s*교체|재설치/, '유심·번호·기기만 바꿨을 때 보통 앱 재설치는 필요 없습니다. VLUE는 가입 시 본인인증한 전화번호·계정에 묶입니다. 같은 계정·같은 번호로 기기만 바꾸면 새 기기에 설치 후 로그인하면 됩니다. 번호를 바꾼 경우 설정→전화번호 안내를 본 뒤 본인인증 후 고객센터(support@vlue.kr)로 번호 갱신을 요청하세요. 자세한 내용은 [고객지원] FAQ를 참고하세요.'],
