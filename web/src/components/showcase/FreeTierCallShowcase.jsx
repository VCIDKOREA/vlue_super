...
export default function FreeTierCallShowcase({
  ...
  if (isKnownContact) {
    return (
      <div className="free-tier-solo free-tier-solo--profile" data-mode="known">
        <LetteringEmotionalFeedPanel
          card={card}
          instagramHandle={instagramHandle || card?.showcaseStyle?.platformFeed?.instagramHandle || ""}
          creatorLink={creatorLink || card.website || ""}
        />
      </div>
    );
  }
