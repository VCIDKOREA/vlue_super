...
## 3. BGM 하이브리드 시스템 (Signature + User Original)

- [ ] 쇼케이스 설정 → **배경음악**: **VLUE Signature Sound** / **User Original Sound** 탭 노출
- [ ] **유료 계정** → User Original → **음원 등록**으로 권리 보유 음원(파일) 업로드 → 등록·쇼케이스 연결·송출 미리보기
- [ ] 업로드 시 권리·동의 체크·일일/보관 쿼터 표시 (`오늘 업로드 n/limit` · 보관 n/limit)
- [ ] **무료 계정** → 음원 업로드 불가 안내 · Signature 선택 또는 Shared Track 퍼오기만 가능
- [ ] Signature 장르 검색·선택 → 미리보기 스피커·쇼케이스 연결
- [ ] 유료: 재생목록·단독/순서/셔플 재생 전환
...
- [ ] 통화 중 **현재 설정된 BGM**(Signature 또는 User Original) Marquee 자막 흐름
- [ ] **「종료 후 재생」** → 선택 음원 **음소거 해제·자동 재생**
- [ ] 통화 목록에서 쇼케이스 재진입 시 터치 unlock 후 BGM 재생
- [ ] (레거시 YouTube 연결이 남아 있는 경우) `youtube-nocookie.com`, 통화 중 `mute=1`
...
4. 쇼케이스 설정 → 사진·BGM(Signature / **유료 User Original 업로드**) 미리보기 · **배너 소셜 오버레이(좋아요·댓글·로고·상태)**  
