...
const DEFAULT_TITLE = "VLUE가 처음 만난 당신에게 💙 그동안 전하지 못한 편지";

const DEFAULT_BODY = `안녕하세요.
VLUE입니다.

아마 이런 생각을 하셨을지도 모르겠습니다.
“그런데… 내 개인정보를 왜 VLUE에 알려줘야 하지?”
...
VLUE는 그런 마음에서 시작했습니다.
거창하지 않습니다.
그저 우리가 매일 사용하는
‘전화’라는 아주 오래된 연결이
다시 조금 더 편안해졌으면 좋겠다는 마음.

그러니 처음부터 VLUE를 믿지 않으셔도 괜찮습니다.
천천히 보셔도 됩니다.
사용해보시고,
궁금한 것이 있으면 물어보시고,
