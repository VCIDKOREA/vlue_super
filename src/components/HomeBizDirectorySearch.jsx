          ...
          >
            ...
            {!selectedId ? (
              <>
                ...
                <div className="home-biz-search__sheet-body min-h-0 flex-1 overflow-y-auto overscroll-contain">
                  {results.length === 0 ? (
              ...
              <div className="home-biz-search__sheet-body min-h-0 flex-1 overflow-y-auto overscroll-contain px-2 pb-2">
